  ...
  <section class="calapsable-containers">
    ...
    <div class="bottom">
      <div class="calapsable-inner">
        <div class="text-holder">
          <p>
          Това уникално решение ви позволява да използвате нашия контейнер, където и когато ви е необходим, дори и на най-изолирани места. Ние сме ангажирани с предоставянето на практични и удобни решения за вашите нужди, независимо от предизвикателствата, пред които сте изправени.
          </p>
        </div>
        <div class="replace-image">
